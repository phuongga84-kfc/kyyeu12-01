/* --- GOLD DUST PARTICLES (Canvas) --- */
        ...
        function initParticles() {
            particlesArray = [];
            for (let i = 0; i < 70; i++) { // Number of particles
        ...
        // Hàm được gọi khi bấm nút "Mở Thiệp Mời"
        function enterParty() {
            // 1. Ẩn màn hình chào mừng
            overlay.classList.add("overlay-hidden");

            // 2. Phát nhạc ngay lập tức (Vì lúc này đã có tương tác click)
            music.play().then(() => {
                isPlaying = true;
                btn.innerHTML = "❚❚"; // Đổi icon thành Pause
        ...
        // Hàm nút bật/tắt nhạc ở góc màn hình
